...
// ******************************************************* 
package com.blastedstudios.badge.server.ai.bt.conditions.execution;
...
public class IsDead extends
	 ...
	 * com.blastedstudios.badge.server.ai.bt.conditions.IsDead.
	 */
	public IsDead(jbt.model.core.ModelTask modelTask,
		...
		if (!(modelTask instanceof com.blastedstudios.badge.server.ai.bt.conditions.IsDead)) {
			throw new java.lang.RuntimeException(
					"The ModelTask must subclass com.blastedstudios.badge.server.ai.bt.conditions.IsDead");
		}
	}
