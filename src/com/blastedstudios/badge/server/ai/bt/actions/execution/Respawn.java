...
public class Respawn extends jbt.execution.task.leaf.action.ExecutionAction {
	 ...
	 * com.blastedstudios.badge.server.ai.bt.actions.Respawn.
	 */
	public Respawn(jbt.model.core.ModelTask modelTask,
		...
		if (!(modelTask instanceof com.blastedstudios.badge.server.ai.bt.actions.Respawn)) {
			throw new java.lang.RuntimeException(
					"The ModelTask must subclass com.blastedstudios.badge.server.ai.bt.actions.Respawn");
		}
	}
