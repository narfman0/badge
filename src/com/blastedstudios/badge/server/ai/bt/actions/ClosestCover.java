...
public class ClosestCover extends jbt.model.task.leaf.action.ModelAction {
	...
	/**
	 * Returns a
	 * com.blastedstudios.badge.server.ai.bt.actions.execution.ClosestCover task
	 * that is able to run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new com.blastedstudios.badge.server.ai.bt.actions.execution.ClosestCover(
