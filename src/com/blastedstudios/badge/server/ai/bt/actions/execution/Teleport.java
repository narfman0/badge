...
public class Teleport extends jbt.execution.task.leaf.action.ExecutionAction {
	 ...
	 * com.blastedstudios.badge.server.ai.bt.actions.Teleport.
	 * 
	 * @param target
	...
	public Teleport(jbt.model.core.ModelTask modelTask,
		...
		if (!(modelTask instanceof com.blastedstudios.badge.server.ai.bt.actions.Teleport)) {
			throw new java.lang.RuntimeException(
					"The ModelTask must subclass com.blastedstudios.badge.server.ai.bt.actions.Teleport");
		}
