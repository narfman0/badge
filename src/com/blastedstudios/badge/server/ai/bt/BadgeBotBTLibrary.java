...
// ******************************************************* 
package com.blastedstudios.badge.server.ai.bt;
		...
		Root = new jbt.model.task.decorator.ModelRepeat(
				...
				new jbt.model.task.composite.ModelSelector(
						...
						new jbt.model.task.composite.ModelSequence(
								null,
								new com.blastedstudios.badge.server.ai.bt.conditions.IsDead(
										null),
								new com.blastedstudios.badge.server.ai.bt.actions.Respawn(
										null),
								new com.blastedstudios.badge.server.ai.bt.actions.Teleport(
										null, null, "RespawnTarget")),
						new jbt.model.task.composite.ModelSequence(
								null,
								new com.blastedstudios.badge.server.ai.bt.conditions.HighDanger(
										null),
								new com.blastedstudios.badge.server.ai.bt.actions.Shoot(
										null, null, "HighDangerTarget"),
								new com.blastedstudios.badge.server.ai.bt.actions.ClosestFriendlyBase(
										null),
								new com.blastedstudios.badge.server.ai.bt.actions.Move(
										null, null, "ClosestFriendlyBaseTarget")),
						new jbt.model.task.composite.ModelSequence(
								null,
								new com.blastedstudios.badge.server.ai.bt.conditions.LowDanger(
										null),
								new com.blastedstudios.badge.server.ai.bt.actions.Shoot(
										null, null, "LowDangerTarget"),
								new com.blastedstudios.badge.server.ai.bt.actions.ClosestCover(
										null),
								new com.blastedstudios.badge.server.ai.bt.actions.Move(
										null, null, "ClosestCoverTarget")),
						new jbt.model.task.composite.ModelSequence(
								null,
								new com.blastedstudios.badge.server.ai.bt.conditions.InCover(
										null),
								new jbt.model.task.composite.ModelSelector(
										null,
										new jbt.model.task.composite.ModelSequence(
						...
						new jbt.model.task.composite.ModelSequence(
								null,
								new com.blastedstudios.badge.server.ai.bt.actions.CurrentObjective(
										null),
								new com.blastedstudios.badge.server.ai.bt.actions.Move(
